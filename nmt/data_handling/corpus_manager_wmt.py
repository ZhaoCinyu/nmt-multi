...
def _main(args: Namespace):
    ...
    src_data = read_data_wmt(args.src_path)
    tgt_data = read_data_wmt(args.tgt_path)
    ...
    write_data_wmt(src_data, args.output_src_path)
    write_data_wmt(tgt_data, args.output_tgt_path)
